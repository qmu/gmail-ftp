...
//! `cfs-txn` signature. A read captures the coordinate it observed; the write that depends
...
pub enum Precondition {
    ...
    /// version the node, [`VersionSupport::None`](cfs_plan-adjacent driver declaration)).
    #[default]
    None,
