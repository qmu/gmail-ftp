...
//! so the driver's [`cfs_plan::PlanApplier`] apply leg stays synchronous like every other
//! driver (the runtime [`cfs_runtime::PlanApplierBridge`] already offloads it to a tokio
