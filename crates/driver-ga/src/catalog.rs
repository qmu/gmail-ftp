...
/// The kind of a GA4 metric value, which fixes the typed cfs column it decodes into.
...
impl MetricKind {
    /// The canonical cfs [`ColumnType`] this metric kind decodes into.
    #[must_use]
...
pub struct GaMetric {
    ...
    pub category: String,
    /// The metric value kind, which fixes the typed cfs column.
    pub kind: MetricKind,
}
