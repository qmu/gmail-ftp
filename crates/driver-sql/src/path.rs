//! [`SqlPath`] — the parse of a cfs [`Path`](cfs_driver::Path) into the concrete SQL node it
//! names (RFD-0001 §5). A SQL database maps onto the **relational archetype**: a table is a
