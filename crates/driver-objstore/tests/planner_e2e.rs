...
//!
//! This is BLACK-BOX validation driven entirely through the crate's PUBLIC API (the `cfs_driver`
...
//!
//! No live S3/R2, no network, no live credentials. Run with `cargo test -p cfs-driver-objstore
//! --test planner_e2e`.
...
use cfs_driver::{check_capability, Driver, Path, PushdownProfile, Verb, VersionSupport};
use cfs_plan::{
