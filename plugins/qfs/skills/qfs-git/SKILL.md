---
name: qfs-git
description: Use when a task needs git through qfs — read a repo's versioned file tree and history over /git, list commits/refs/tags, read a directory as of a tag or branch with the @<ref> coordinate, and record a commit.
---
